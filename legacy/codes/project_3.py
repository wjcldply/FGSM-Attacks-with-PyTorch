...
# CUDA_VISIBLE_DEVICES=0 nohup python -u project_3.py > combination_nohup.out 2>&1 &
# CUDA_VISIBLE_DEVICES=1 nohup python -u project_3.py --port 6000 > combination_nohup_2.out 2>&1 &
# CUDA_VISIBLE_DEVICES=1 nohup python -u project_3.py --port 6000 > combination_nohup_3.out 2>&1 &
# CUDA_VISIBLE_DEVICES=0 nohup python -u project_3.py --port 6100 > combination_nohup_4.out 2>&1 &
...
epsilons = [16, 32, 48, 64, 80, 96, 112, 128] # L_inf norm bound
