# CUDA_VISIBLE_DEVICES=0 nohup python -u project_6.py --port 6600 > project_6_testResults.out 2>&1 &
setup = "| Normalize(X) | alpha=epsilon/iter | MI-FGSM (D 제외) |"
print(setup)
...
epsilons = [16/255, 32/255, 48/255] # L_inf norm bound
