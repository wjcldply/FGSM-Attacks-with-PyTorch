# CUDA_VISIBLE_DEVICES=0 nohup python -u D_MI_FGSM_1.py --port 7100 > D_MI_FGSM_1_TestResults.out 2>&1 &
setup = "[ NO Normalization | step: alpha=epsilon/iter | type: D-MI-FGSM ]"
print(f'Training SETUP -> {setup}')
print('(Delta applied at both Diversity Function Call & RESNET Model Inference)')
...
batch_size = 20
max_iterations = [50, 100, 200, 400, 800]
input_path = 'images/'
...
for epsilon in epsilons:
    for max_iteration in max_iterations:
        ...
        df_submission.to_csv(f'submission_iter{max_iteration}_eps{epsilon_rounded}_Delta2.csv')
        print(f'submission.csv file for iter{max_iteration}_eps{epsilon_rounded}_2Delta SAVED SUCCESSFULLY')
